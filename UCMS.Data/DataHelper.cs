...
namespace UCMS.Data
{
    internal class DataHelper
    {
        ...
        public static List<WFProcess> ReadWfProcesses(IDataReader reader)
        {
            var list = new List<WFProcess>();
            while (reader.Read())
            {
                var item = new WFProcess
                {
                    Id = reader["Id"].ToString(),
                    Name = reader["Name"].ToString(),
                    Description = reader["Description"].ToString()
        ...
        public static List<WFProcessRoute> ReadWfProcessRoute(IDataReader reader)
        {
            var list = new List<WFProcessRoute>();
            while (reader.Read())
            {
                var item = new WFProcessRoute
                {
                    Id = reader["Id"].ToString(),
                    FromStepId = reader["FromStepId"].ToString(),
                    ToStepId = reader["ToStepId"].ToString(),
                    RoutingParam = reader["RoutingParam"]
                };
                list.Add(item);
            }
            return list;
        ...
        public static List<WFProcessStep> ReadWfProcessSteps(IDataReader reader)
        {
            var list = new List<WFProcessStep>();
            while (reader.Read())
            {
                var item = new WFProcessStep
                {
                    Id = reader["Id"].ToString(),
                    Name = reader["Name"].ToString(),
                    Description = reader["Description"].ToString()
